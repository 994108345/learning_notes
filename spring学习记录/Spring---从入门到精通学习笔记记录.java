1 Spring 概述
	Spring 框架由7大模块组成
	核心容器：提供了Speing框架的核心功能。BeanFactory是Speing核心容器的主要组件。它通过控制反转将应用程序的配置和依赖性规范与实际的应用程序代码分开。
...
Spring的特点：
 ...
 4：Spring能tidaiEJB，如果开发人员使用EJB，则使用Sring后还可以继续使用EJB。
...
3 Spring基础概念
	...
	3.4 使用哪种注入方式
	各有各的好
	要在对象简历时就准备好所有的资源，就使用构造注入，在对象建立后才需要注入，就使用Set注入。
	3.5 小结
	Spring的核心是哥IoC容器。
